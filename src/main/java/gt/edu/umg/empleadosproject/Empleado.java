...
public class Empleado extends javax.swing.JDialog {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtTelefono, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //consulta
                String query = "Insert Into empleado values (null, '"+nombre+"','"+direccion+"','"+telefono+"')";
                System.out.println(query);
        try {
            
            Statement st = cnx.createStatement();
            int queryStatus = st.executeUpdate(query);
